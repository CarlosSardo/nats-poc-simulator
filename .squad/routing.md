...
|-----------|----------|----------|
| Architecture, project structure, scope | Ripley 🏗️ | Solution layout, project decisions, interfaces |
| .NET/C# implementation, NATS integration | Dallas 🔧 | Services, models, NATS pub/sub, Docker |
| Frontend, UI, dashboards, browser pages | Parker ⚛️ | HTML, CSS, JS, real-time UI, SignalR, WebSocket |
| Tests, QA, edge cases | Lambert 🧪 | Unit tests, integration tests, scenario validation |
| Code review | Ash 🔬 | Review PRs, verify domain correctness, gate merges |
| Domain guidance | Ash 🔬 | NATS patterns, IoT conventions, PLC fidelity |
| Verification | Ash 🔬 | Validate implementations match requirements |
| Testing | Lambert 🧪 | Write tests, find edge cases, verify fixes |
| Scope & priorities | Ripley 🏗️ | What to build next, trade-offs, decisions |
